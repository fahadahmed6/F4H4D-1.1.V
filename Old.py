...
class Main:
	def __init__(self):
		...
		print ("""\033[1;92m 
F)ffffff   A)aa   H)    hh   A)aa   D)dddd   
F)        A)  aa  H)    hh  A)  aa  D)   dd  
F)fffff  A)    aa H)hhhhhh A)    aa D)    dd 
F)       A)aaaaaa H)    hh A)aaaaaa D)    dd 
F)       A)    aa H)    hh A)    aa D)    dd 
F)       A)    aa H)    hh A)    aa D)ddddd  
                                             
                                             

\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : FAHAD HOSSEN
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : UNKNOWN  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : fahadahmed6
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/Bou.Er.Xamai.Tah ")
		print(" [*] Instagram : Chalai nah 🫤")
		print(" [*] YouTube   : https://youtube.com/@Gw_fahad.69?si=ym5x0RQh-r0RWnLL")
		exit(" [*] GitHub    : https://github.com/fahadahmed6")
	else:
		Main()
